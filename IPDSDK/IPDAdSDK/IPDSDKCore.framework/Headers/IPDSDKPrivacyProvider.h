//
//  IPDSDKPrivacyProvider.h
//  IPDSDKCore
//
//  Created by 麻明康 on 2025/1/21.
//

#ifndef IPDSDKPrivacyProvider_h
#define IPDSDKPrivacyProvider_h

@protocol IPDSDKPrivacyProvider <NSObject>
