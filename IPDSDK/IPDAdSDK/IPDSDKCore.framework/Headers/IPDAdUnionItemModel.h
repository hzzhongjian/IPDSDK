...
// 信息流和banner融合
FOUNDATION_EXPORT NSString * const IPD_ADType_NativeExpress_Banner;
// 信息流实现的开屏
FOUNDATION_EXPORT NSString * const IPD_ADType_NativeExpress_Splash;
// 信息流实现的插屏
FOUNDATION_EXPORT NSString * const IPD_ADType_NativeExpress_Interstitial;
// 信息流实现的激励
FOUNDATION_EXPORT NSString * const IPD_ADType_NativeExpress_RewardVideo;
// 自渲染实现的开屏
FOUNDATION_EXPORT NSString * const IPD_ADType_Native_Splash;
// 自渲染实现的插屏
FOUNDATION_EXPORT NSString * const IPD_ADType_Native_Interstitial;
// 自渲染实现的激励
FOUNDATION_EXPORT NSString * const IPD_ADType_Native_RewardVideo;
// 自渲染实现的信息流
FOUNDATION_EXPORT NSString * const IPD_ADType_Native_NativeExpress;
// 自渲染实现的Banner
FOUNDATION_EXPORT NSString * const IPD_ADType_Native_Banner;



typedef NS_ENUM(NSInteger,IPDAdShowPriority){
    IPDAdShowPriority_normal, // 返回快
    IPDAdShowPriority_weight, // 权重
    IPDAdShowPriority_highPrice, // 更高价格
