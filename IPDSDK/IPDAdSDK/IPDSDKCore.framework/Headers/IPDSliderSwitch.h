...
@class IPDSliderSwitch;
@protocol IPDSliderSwitchDelegate <UIScrollViewDelegate>
@required
 ...
 */
- (UIView <IPDSliderSwitchProtocol>*)sliderSwitch:(IPDSliderSwitch *)sliderSwitch setSubViewInIndex:(NSInteger)index;

@optional
- (void)sliderSwitch:(IPDSliderSwitch *)sliderSwitch didSelectedIndex:(NSInteger)selectedIndex bySlideWay:(IPDSlideWay)slideWay isFirstSlide:(BOOL)isFirstSlide;
/*! 选中selectedIndex 回调*/
//- (void)sliderSwitch:(SliderSwitch *)sliderSwitch didSelectedIndex:(NSInteger)selectedIndex;
- (void)sliderSwitch:(IPDSliderSwitch *)sliderSwitch didSelectedIndex:(NSInteger)selectedIndex bySlideWay:(IPDSlideWay)slideWay;

- (void)sliderSwitch:(IPDSliderSwitch *)sliderSwitch didRepeatSelectedIndex:(NSInteger)selectedIndex bySlideWay:(IPDSlideWay)slideWay;

- (void)sliderSwitchDidDoubleClickBlank:(IPDSliderSwitch *)sliderSwitch;

@end


@interface IPDSliderSwitch <T>: UIScrollView
/*! 数据源*/
@property(nonatomic,strong) NSMutableArray <IPDSWModel *>*dataArray;
/*! visiablePageViews可见控制器数组*/
@property(nonatomic,strong)NSMutableArray <IPDSWModel *>*visiablePageViews;
/*! title的未选中字色*/
...
/*! 当前选中pageView*/
@property(nonatomic,strong) UIView <IPDSliderSwitchProtocol>*  selectedPageView;
/*! 容器ScrollView*/
...
@property(nonatomic,weak) id<IPDSliderSwitchDelegate> delegate;

-(void)setDataArray:(NSMutableArray<IPDSWModel *> *)dataArray autoSize:(BOOL)autoSize;
...
/// @param SlideWay 	 触发方式
-(void)slideToIndex:(NSInteger)idx animated:(BOOL)animated bySlideWay:(IPDSlideWay)slideWay;
...
-(void)slideToIndex:(NSInteger)idx animated:(BOOL)animated bySlideWay:(IPDSlideWay)slideWay complete:(void(^)(void))completion;
