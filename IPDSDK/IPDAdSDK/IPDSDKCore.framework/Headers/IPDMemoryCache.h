...
/**
 A protocol to allow custom memory cache used in IPDCache.
 */
@protocol IPDMemoryCache <NSObject>
...
@interface IPDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType><IPDMemoryCache>
