...
// 广告加载相关回调
@protocol IPDContentAdapterLoadCallBackProtocol <NSObject>
...
@protocol IPDShortPlayPlayerCallBackProtocol <NSObject>
...
// 广告回调
@protocol IPDShortPlayAdCallBackProtocol <NSObject>
...
// 业务接口回调
@protocol IPDShortPlayInterfaceCallBackProtocol <NSObject>
...
// 自定义详情页cell试图
@protocol IPDShortPlayCustomViewCallBackProtocol <NSObject>
...
/// 自定义Draw流的subview
@protocol IPDShortPlayCustomDrawAdViewCallBackProtocol <NSObject>
...
/// 滑滑溜底部自定义Banner广告
@protocol IPDShortPlayDrawVideoViewControllerBannerCallBackProtocol <NSObject>
