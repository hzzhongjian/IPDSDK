 ...
 */
+ (void)registerSDK:(IPDSDKInitModel *)initModel;
 ...
 */
+ (void)registerSDK:(IPDSDKInitModel *)initModel callback:(void(^)(BOOL completed, NSDictionary *info))callback;
 ...
 *请在SDK初始化之前使用
 */
+ (void)persionalizedState:(IPDSDKPersionalizedState)persionalizedState;
 ...
 *请在SDK初始化之前使用
 */
+ (void)programmaticRecommend:(IPDSDKProgrammaticRecommend)enableProgrammaticRecommend;
