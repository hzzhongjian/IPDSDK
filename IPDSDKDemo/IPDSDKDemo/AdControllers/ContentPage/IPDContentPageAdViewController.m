//
//  IPDContentPageAdViewController.m
//  ZJSDKDemo
//
...
#import "IPDContentPageAdViewController.h"
#import <IPDSDK/IPDContentPageAd.h>

@interface IPDContentPageAdViewController () <IPDContentPageVideoStateDelegate, IPDContentPageStateDelegate, IPDContentPageLoadCallBackDelegate>

@property (nonatomic, strong) IPDContentPageAd *contentPageAd;

@property (nonatomic, strong) UIViewController *contentPageVC;

@end

@implementation IPDContentPageAdViewController
...
{
    [super loadAd:adId];
    self.contentPageAd = [[IPDContentPageAd alloc]initWithPlacementId:adId];
