...
@interface IPDContentPageTabBarController ()

@end

@implementation IPDContentPageTabBarController
...
- (void)viewDidLoad {
    ...
    IPDContentPageStyle1ViewController *vc1 = [[IPDContentPageStyle1ViewController alloc] init];
    ...
    IPDContentPageStyle2ViewController *vc3 = [[IPDContentPageStyle2ViewController alloc] init];
