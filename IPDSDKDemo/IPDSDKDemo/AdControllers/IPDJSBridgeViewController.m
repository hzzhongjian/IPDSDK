...
#import "IPDJSBridgeViewController.h"
#import <WebKit/WebKit.h>
#import <IPDSDK/IPDWKWebViewBridge.h>
@interface IPDJSBridgeViewController ()<WKNavigationDelegate,WKUIDelegate,IPDH5PageDelegate>
{
    WKWebView *_webView;
    bool _hasLoad;
}
...
@property (nonatomic, strong) IPDWKWebViewBridge *zjWKWebViewBridge;
@end

@implementation IPDJSBridgeViewController
...
- (void)viewDidLoad {
    ...
    self.zjWKWebViewBridge = [IPDWKWebViewBridge new];
