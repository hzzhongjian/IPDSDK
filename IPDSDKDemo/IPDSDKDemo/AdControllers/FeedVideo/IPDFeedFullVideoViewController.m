...
#import "IPDFeedFullVideoViewController.h"
#import "IPDFeedFullVideoShowViewController.h"

@interface IPDFeedFullVideoViewController ()

@end

@implementation IPDFeedFullVideoViewController
...
-(void) loadAd:(NSString*) adId{
    [super loadAd:adId];
    IPDFeedFullVideoShowViewController *showVC = [IPDFeedFullVideoShowViewController new];
