...
#import "IPDHorizontalFeedPageLoadVC.h"
#import "IPDHorizontalFeedPageVC.h"
#import "IPDContentPageTabBarController.h"
#import "UIButton+Event.h"
@interface IPDHorizontalFeedPageLoadVC ()

@end

@implementation IPDHorizontalFeedPageLoadVC
...
- (void)viewDidLoad {
    ...
    [self.loadAdView.loadButton clickHandle:^(UIButton *button) {
        IPDHorizontalFeedPageVC *feedPage = [[IPDHorizontalFeedPageVC alloc]init];
